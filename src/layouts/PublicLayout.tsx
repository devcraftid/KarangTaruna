...
export default function PublicLayout() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col pb-16 md:pb-0">
      ...
      <nav 
        className="lg:hidden fixed bottom-0 left-0 right-0 bg-card border-t flex justify-around items-center h-16 z-50 px-2 shadow-[0_-4px_10px_rgba(0,0,0,0.05)] transform-gpu transition-transform"
        ...
        <div className="lg:hidden fixed inset-0 z-30 bg-white dark:bg-card pt-20 px-4 pb-20 overflow-y-auto animate-in fade-in slide-in-from-bottom-8 duration-300">
          <div className="space-y-6 max-w-sm mx-auto">
            ...
            <div className="space-y-3 pt-4 border-t border-slate-200 dark:border-slate-800">
              <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest px-2">Akses Admin</h3>
              <div className="grid gap-2">
                {user ? (
